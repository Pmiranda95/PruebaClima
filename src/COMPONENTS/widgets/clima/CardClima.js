...
class  CardClima extends React.Component{
  ...
  render(){
    /*
    ESTE COMPONENTE SE PUDO HACER GENERICO Y TAMBIEN HABERSE LLAMADO CUANDO SE SELECCIONABA LA CIUDAD PERO Y
   PASARLE LOS PROPS PERO POR LO QUE ENTENDI AL SELECCIONAR CADA CIUDAD QUERIAN MOSTRAR EL CLIMA Y NO LOS POSTERIORES DIAS */
